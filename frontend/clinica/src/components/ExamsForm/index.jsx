...
const ExamsForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const dataHora = `${examData.data_exame}T${examData.hora_exame}`;
